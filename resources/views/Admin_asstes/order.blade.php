...
@section('content')
        ...
        <div class="card mt-2">
            ...
            <div class="card-header">
                <h4>Orders</h4>
                <a href="{{url('superadmin/admin_index')}}"><button class="btn btn-success">New Work Order</button></a>
            </div>
                    ...
                    <table class="table zero-configuration">
                        ...
                        @foreach($orderdetail as $order)
                            <tr>
                                ...
                                <td>{{$order->user->name}}</td>
                                <td ><a href="{{url('superadmin/edit_option/'.$order->id)}}"> <button type="button" class="btn btn-primary ml-lg-1 ml-md-1 mt-1"  data-toggle="modal" data-target="#exampleModal">
                                    Edit
                                  </button></a><a href="{{url('superadmin/order_detail/'.$order->id)}}"> <button type="button" class="btn btn-info ml-lg-1 ml-md-1 mt-1"  data-toggle="modal" data-target="#exampleModal">
                                    View
